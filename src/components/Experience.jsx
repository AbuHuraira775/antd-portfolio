...
const experienceData = [
  {
    ...
    company: "iTanz Technology (Pvt) Limited",
    logo: 'images/itanz-logo.jpeg',
    website: "https://itanzgroup.com//clone/",
    date: "2025 APR - Present",
    description: "As a Graduate Trainee at ITANZ (Australia), I work on developing healthcare applications using OIC, VBCS, Vue.js, and Spring Boot, focusing on API integration, secure backend services, and interoperability with NHS systems, while collaborating in Agile teams to ensure compliance with healthcare standards."
  },
  {
